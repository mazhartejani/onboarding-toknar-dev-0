...
import { validateComapnyName, validateCountry, validateDate, validateDbaName, validateDuns, validateIndustry, validateName, validateNumEmployees, validateRegNumber, validateSector, validateType, validateUrl } from "../../../../helper/helper";
